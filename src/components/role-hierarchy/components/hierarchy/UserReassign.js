...
import { USER_REASSIGN as FormElements } from './FormElements';
...
export default class UserReassign extends Component {
  ...
  getAllHierarcyies = () => {
    ...
    this.props.ajaxUtil.sendRequest(this.props.const_SalesHierarchy.GET_HIERARCHY_DROPDOWN_LIST, reqData, (response) => {
